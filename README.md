...
### 3. 📊 Live Market Scraper (Goszakup.kz)
- goszakup.gov.kz сайтынан бастапқы бюджетті, жеткізу орнын және төлем шарттарын нақты уақытта алу.
- "Risk Gauge" арқылы баға ауытқуларын және бюджеттік шығынды автоматты есептеу.

### 4. 🛰️ Expert Forensic Console (Explainability)
- ИИ-дің әрбір қадамын (parsing, validation, mapping) көрсететін техникалық логикалық консоль.
- Бұзушылықтарды ҚР Қылмыстық кодексі мен Сатып алу заңының нақты баптарына автоматты байлау.

### 5. 🗣️ Local Forensic Expert Chat
...
| **Phase 2** | Live-скрапинг және нақты уақыттағы бағалар | ✅ Дайын |
| **Phase 3** | Expert Console (Explainability) және Заңды Mapping | ✅ Дайын |
